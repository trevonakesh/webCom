...
export default function Q2() {
  return (
    <>
     {/*section 1*/}
      <div>
        <h1 className="font-bold p-5"><CiDeliveryTruck size={25}/>Delivery and order tracking</h1>
        <div className="px-7">
       ...
       {/*section 2*/}
      <div>
        <h1 className=""><PiKeyReturnLight size={25}/>Returns,Exchanges and Refunds</h1>
        <div>
        <Accordion type="single" collapsible>
                  <AccordionItem value="item-1">
                    <AccordionTrigger>
       ...
       {/*section 3*/}
      <div>
        <h1 className=""><MdOutlinePayment size={25}/>Payments and promotions</h1>
        <div>
        <Accordion type="single" collapsible>
                  <AccordionItem value="item-1">
                    <AccordionTrigger>
        ...
        {/*section 4*/}
      <div>
        <h1 className=""> <PiCoatHanger size={25}/>Informations on sizes and products</h1>
        <div>
        <Accordion type="single" collapsible>
                  <AccordionItem value="item-1">
                    <AccordionTrigger>
      ...
      {/*section 5*/}
      <div>
        <h1 className=""><BsPerson size={25}/>Personal data and notification</h1>
        <div>
        <Accordion type="single" collapsible>
                  <AccordionItem value="item-1">
                    <AccordionTrigger>
